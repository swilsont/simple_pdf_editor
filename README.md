...
**637 KB** (248 KB comprimidos con gzip). De eso, 513 KB son pdf-lib incrustado: el 81% del archivo es la librería que hace el trabajo pesado, y viene adentro justamente para que once de las quince herramientas funcionen sin conexión.
